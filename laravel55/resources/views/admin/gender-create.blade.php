...
<div class="col-md-10 p-4 admin container" id="1Detail">
  <h1 class="redText font30 text-center">Add Gender</h1>

<form class="p-1 col-md-10 border-top mx-auto" method="post" action="{{ route('gender.store') }}">
...
<input type="text" class="form-control titlename" name="name" required value="{{ old('name') }}" placeholder="Name"/>
</div>
...
<div class="input-group-prepend">
<div class="input-group-text"><i class="fa fa-user"></i></div></div>
<input type="text" class="form-control nameslug" name="slug" required value="{{ old('slug') }}" placeholder="Slug" />
</div>
@if ($errors->has('slug'))
<span class="help-block">
    {{ $errors->first('slug') }}
