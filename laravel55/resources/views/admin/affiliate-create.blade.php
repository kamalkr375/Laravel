...
<div class="col-md-10 p-4 admin container" id="1Detail">
  <h1 class="redText font30 text-center">Add Affiliate</h1>

<form class="p-1 col-md-10 border-top mx-auto" method="post" action="{{ route('affiliate.store') }}">
...
<input type="text"  value="{{ old('phone_number') }}" required name="phone_number" placeholder="Phone Number" class="form-control aopcontact"  />
</div>
...
<input type="text" class="form-control" required value="{{ old('website') }}" name="website"
   placeholder="Website">
</div>
...
<div class="input-group">
<span class="input-group-text p-3"><i class="fa fa-internet-explorer"></i></span>
<input type="text" class="form-control" required value="{{ old('commission ') }}" name="commission"
