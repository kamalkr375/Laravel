...
<form class="p-1 col-md-10 border-top mx-auto" method="post" action="{{ route('vendor.store') }}">
...
<input type="text" class="form-control" value="{{ old('website') }}" required name="website"
   placeholder="Website"> 
</div>
