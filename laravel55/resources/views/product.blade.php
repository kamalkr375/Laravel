  ...
  <div class="container-fluid grayBg pt-3 pb-3">
    ...
    <div class="clearfix"></div>
     <div class="container-fluid">
   		...
   		<div class="container">
       <aside class="prLeftNav">
        <p>Price Range</p>
            <p class="priceRangeOption clearfix" ><input type="text" placeholder="Rs 100"> <span>to</span> <input type="text" placeholder="Rs 1000" class="bigTo"> <input type="submit" value="Go"></p>          
             	
       		<h6 class="red font-weight-bold pt-3">Refine By</h6>

            <h5><span class="clearAll red size16">Clear All</span></h5>
            <p class="font-weight-bold cursor-pointer topArrow">Gender </p>
            <ul class="bb-gray">
            ...
            <p class="font-weight-bold cursor-pointer topArrow">Recipient</p>
            <ul class="bb-gray">
            	<li><input type="checkbox" id="Wife"> <label for="Wife"> Wife </label> </li>
                <li><input type="checkbox" id="Husband"> <label for="Husband"> Husband</label></li>
                <li><input type="checkbox" id="Mother"> <label for="Mother"> Mother</label></li>
                 <li><input type="checkbox" id="Father"> <label for="Father"> Father</label></li>
                  <li><input type="checkbox" id="Girlfriend"> <label for="Girlfriend"> Girlfriend</label></li>
            </ul>
            <p class="font-weight-bold cursor-pointer topArrow">Occasion</p>
            <ul class="bb-gray">
            	<li><input type="checkbox" id="Birthday"> <label for="Birthday"> Birthday</label>  </li>
                <li><input type="checkbox" id="Anniversary"> <label for="Anniversary"> Anniversary</label></li>
                <li><input type="checkbox" id="Easter"> <label for="Easter"> Easter</label></li>
                 <li><input type="checkbox" id="Wedding"> <label for="Wedding"> Wedding</label></li>
                  <li><input type="checkbox" id="Baisakhi"> <label for="Baisakhi"> Baisakhi</label></li>
            </ul>
             <p class="font-weight-bold cursor-pointer topArrow">Gift Type</p>
            <ul class="bb-gray">
            	<li><input type="checkbox" id="Flowers"> <label for="Flowers"> Flowers</label>  </li>
                <li><input type="checkbox" id="Decor"> <label for="Decor"> Home Decor</label></li>
                <li><input type="checkbox" id="Hampers"> <label for="Hampers"> Combos & Hampers</label></li>
                 <li><input type="checkbox" id="Accessories"> <label for="Accessories"> Accessories</label></li>
                  <li><input type="checkbox" id="Cards"> <label for="Cards"> Greeting Cards</label></li>
                   <li><a href="#">View All</a></li>
            </ul>
           
            
       </aside>
       <section class="prListing">
       <h1 class="size24"><span class="red bb-red">Personalised</span> Gifts</h1>
       <ol class="sorting size16 pt-3 pb-5">
       		
           
            <li><select class="locators size16" name="ddlOrderby" id="ddlOrderby">
                                <option value="3" selected="selected">Relevance</option>
                             ...
                             <li>Sort By: </li>
                            <li>View: <span class="red">3000</span></li>
       </ol>
       <div class="clearfix"></div>
       		<ul class="text-center">
             <li> <picture><img src="<?php echo  url('/');?>/public/frontend/images/products/31.jpg" alt="Archies" srcset="images/products/1BigDouble.jpg 2x"><i class="prOverlay"></i><span class="newBtn"></span> <p  class="text-center text-uppercase prBtn"><a href="#">Buy Now</a></p></picture>    
    <p class="size18 mb-0 mt-2">Note Hydra Color 13 Fiesta...</p>
    <p class="red size22">Rs 575</p>
    </li>
             <li> <picture><img src="<?php echo  url('/');?>/public/frontend/images/products/28.jpg" alt="Archies" srcset="images/products/1BigDouble.jpg 2x"><i class="prOverlay"></i><span class="newBtn"></span> <p  class="text-center text-uppercase prBtn"><a href="#">Buy Now</a></p></picture>    
    <p class="size18 mb-0 mt-2">Pie Of Affection</p>
    <p class="red size22">Rs 2745</p>
    </li>
     <li> <picture><img src="<?php echo  url('/');?>/public/frontend/images/products/29.jpg" alt="Archies" srcset="images/products/1BigDouble.jpg 2x"><i class="prOverlay"></i><span class="newBtn"></span> <p  class="text-center text-uppercase prBtn"><a href="#">Buy Now</a></p></picture>    
    <p class="size18 mb-0 mt-2">Pie Of Affection</p>
    <p class="red size22">Rs 2745</p>
    </li>
	<li> <picture><img src="<?php echo  url('/');?>/public/frontend/images/products/24.jpg" alt="Archies" srcset="images/products/1BigDouble.jpg 2x"><i class="prOverlay"></i> <span class="newBtn"></span><p  class="text-center text-uppercase prBtn"><a href="#">Buy Now</a></p></picture>    
    <p class="size18 mb-0 mt-2">Romance Cherry</p>
    <p class="red size22">Rs 399</p>
    </li>
    <li> <picture><img src="<?php echo  url('/');?>/public/frontend/images/products/25.jpg" alt="Archies" srcset="images/products/1BigDouble.jpg 2x"><i class="prOverlay"></i><span class="newBtn"></span> <p  class="text-center text-uppercase prBtn"><a href="#">Buy Now</a></p></picture>    
    <p class="size18 mb-0 mt-2">Note Hydra Color 13 Fiesta...</p>
    <p class="red size22">Rs 575</p>
    </li>
    ...
    <p class="size18 mb-0 mt-2">Holi Hai Personalised Mug</p>
    <p class="red size22">Rs 349</p>
    </li>
    <li> <picture><img src="<?php echo  url('/');?>/public/frontend/images/products/28.jpg" alt="Archies" srcset="images/products/1BigDouble.jpg 2x"><i class="prOverlay"></i> <p  class="text-center text-uppercase prBtn"><a href="#">Buy Now</a></p></picture>    
    <p class="size18 mb-0 mt-2">Pie Of Affection</p>
    <p class="red size22">Rs 2745</p>
    </li>
     <li> <picture><img src="<?php echo  url('/');?>/public/frontend/images/products/29.jpg" alt="Archies" srcset="images/products/1BigDouble.jpg 2x"><i class="prOverlay"></i> <p  class="text-center text-uppercase prBtn"><a href="#">Buy Now</a></p></picture>    
    <p class="size18 mb-0 mt-2">Pie Of Affection</p>
    <p class="red size22">Rs 2745</p>
    </li>
    		<li> <picture><img src="<?php echo  url('/');?>/public/frontend/images/products/30.jpg" alt="Archies" srcset="images/products/1BigDouble.jpg 2x"><i class="prOverlay"></i> <p  class="text-center text-uppercase prBtn"><a href="#">Buy Now</a></p></picture>    
    <p class="size18 mb-0 mt-2">Romance Cherry</p>
    <p class="red size22">Rs 399</p>
    </li>
    <li> <picture><img src="<?php echo  url('/');?>/public/frontend/images/products/31.jpg" alt="Archies" srcset="images/products/1BigDouble.jpg 2x"><i class="prOverlay"></i> <p  class="text-center text-uppercase prBtn"><a href="#">Buy Now</a></p></picture>    
    <p class="size18 mb-0 mt-2">Note Hydra Color 13 Fiesta...</p>
    <p class="red size22">Rs 575</p>
    </li>
    <li> <picture><img src="<?php echo  url('/');?>/public/frontend/images/products/32.jpg" alt="Archies" srcset="images/products/1BigDouble.jpg 2x"><i class="prOverlay"></i> <p  class="text-center text-uppercase prBtn"><a href="#">Buy Now</a></p></picture>    
    <p class="size18 mb-0 mt-2">Holi Hai Personalised Mug</p>
    <p class="red size22">Rs 349</p>
    </li>
    <li> <picture><img src="<?php echo  url('/');?>/public/frontend/images/products/33.jpg" alt="Archies" srcset="images/products/1BigDouble.jpg 2x"><i class="prOverlay"></i> <p  class="text-center text-uppercase prBtn"><a href="#">Buy Now</a></p></picture>    
    <p class="size18 mb-0 mt-2">Pie Of Affection</p>
    <p class="red size22">Rs 2745</p>
    </li>
     <li> <picture><img src="<?php echo  url('/');?>/public/frontend/images/products/34.jpg" alt="Archies" srcset="images/products/1BigDouble.jpg 2x"><i class="prOverlay"></i> <p  class="text-center text-uppercase prBtn"><a href="#">Buy Now</a></p></picture>    
    <p class="size18 mb-0 mt-2">Pie Of Affection</p>
    <p class="red size22">Rs 2745</p>
    </li>
    	
</ul>
<aside class="pageyFilter yellowBg text-center mt-5 mb-5">
<h5 class="white pt-4 pb-2 size24">Filter by Categories</h5>
	<ol>
    	<li><a href="#"><img src="<?php echo  url('/');?>/public/frontend/images/icon/women.png" alt="Women"><br />Women</a></li>
        <li><a href="#"><img src="<?php echo  url('/');?>/public/frontend/images/icon/men.png" alt="Men"><br/>Men</a></li>
        <li><a href="#"><img src="<?php echo  url('/');?>/public/frontend/images/icon/couple.png" alt="Couple"> <br/>Couple</a></li>
        <li><a href="#"><img src="<?php echo  url('/');?>/public/frontend/images/icon/gift.png" alt="Gift Types"><br/>Gift Types</a></li>
        </ol>
       
        <p><a href="#">All Filters</a></p>
</aside>
<ul class="text-center">
             <li> <picture><img src="<?php echo  url('/');?>/public/frontend/images/products/31.jpg" alt="Archies" srcset="images/products/1BigDouble.jpg 2x"><i class="prOverlay"></i><span class="newBtn"></span> <p  class="text-center text-uppercase prBtn"><a href="#">Buy Now</a></p></picture>    
    <p class="size18 mb-0 mt-2">Note Hydra Color 13 Fiesta...</p>
...
<div class="clearfix"></div>
<p class="text-center pt-4 pb-4 moreBtn"><a href="#" class="">More Gifts</a></p>
       </section>
