...
(2, 'Nitay', 'Nitay Goranga', '8978787867', 'http://www.google.com', 10, '2018-05-16 07:09:54', '2018-05-30 02:15:01');
...
(1, 'Airtel', 're6', 'Full Desc', 'love-1522043546.png', '2018-03-26 00:22:26', '2018-03-26 07:11:36'),
(7, 'vz', 'asdf', 'adsfa', 'download_banner-1522331075.jpg', '2018-03-29 08:14:35', '2018-03-29 08:14:35'),
(9, 'dkdkd dafssa', 'dkdkd-dafssa', '<p>dkdkkd</p>', '', '2018-05-23 07:32:08', '2018-05-23 07:32:26'),
(10, 'euheuh', 'euheuh', '<p>wnmd wnd</p>', '', '2018-05-29 00:03:46', '2018-05-30 00:01:07');
...
(11, 'Test1', 'test1', '<p>meta desc</p>', 'downo21527149707.jpg', NULL, NULL, 1, '2018-05-24 02:45:07', '2018-05-30 00:50:44');
...
INSERT INTO `cities` (`id`, `country_id`, `state_id`, `name`) VALUES
(1, 7, 5, 'Katihar'),
(3, 6, 3, 'Flori-1');
...
CREATE TABLE `landingpages` (
  ...
  `page_type_category_id` int(11) NOT NULL,
  `name` varchar(250) NOT NULL,
...
INSERT INTO `landingpages` (`id`, `page_type`, `page_type_category_id`, `name`, `heading_name`, `images`, `status`) VALUES
(1, 'ocassion', 1, 'Abhishek', 'pg', '{\"1\":{\"priority\":1,\"type\":\"img\",\"name\":\"image-1\",\"value\":\"download1528350949.jpg\"},\"2\":{\"priority\":2,\"type\":\"img\",\"name\":\"image-2\",\"value\":\"download_banner1528350950.jpg\"},\"3\":{\"priority\":3,\"type\":\"img\",\"name\":\"image-3\",\"value\":\"downo21528350950.jpg\"}}', 1);

-- --------------------------------------------------------

--
-- Table structure for table `landingpage_categories`
--

CREATE TABLE `landingpage_categories` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `landingpage_categories`
--

INSERT INTO `landingpage_categories` (`id`, `landingpage_id`, `category_id`, `priority`) VALUES
(1, 1, 7, 1),
(2, 1, 8, 2),
(3, 1, 7, 3);
...
--
-- Table structure for table `landingpage_subcategories`
--

CREATE TABLE `landingpage_subcategories` (
  `id` int(11) NOT NULL,
  `landingpage_id` int(11) NOT NULL,
  `landingpage_category_id` int(11) NOT NULL,
  `subcategory_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `landingpage_subcategories`
--

INSERT INTO `landingpage_subcategories` (`id`, `landingpage_id`, `landingpage_category_id`, `subcategory_id`) VALUES
(1, 1, 1, 8),
(2, 1, 1, 9),
(3, 1, 2, 11),
(4, 1, 3, 8),
...
--
-- Table structure for table `migrations_`
--

CREATE TABLE `migrations_` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `migrations_`
--

INSERT INTO `migrations_` (`id`, `migration`, `batch`) VALUES
...
(45, 3, 36, 67, '2018-06-04 02:11:25', '2018-06-04 02:11:25');
...
--
-- Table structure for table `product_location_products`
--

CREATE TABLE `product_location_products` (
  `id` int(11) NOT NULL,
...
(5, 'adfas', 's', '<p>dd</p>', 'archieslogo1523963011.png', 1, 1, 0, '2018-04-17 05:33:31', '2018-05-30 01:25:24');
...
(20, 9, 'mugs', 'mugs', NULL, NULL, 1, '2018-05-29 00:07:51', '2018-05-30 00:59:14');
...
(35, 20, 'Att1', '2018-05-30 00:59:14', '2018-05-30 00:59:14'),
(36, 20, 'Att2', '2018-05-30 00:59:14', '2018-05-30 00:59:14');
...
(65, 35, 'Black', '2018-05-30 00:59:14', '2018-05-30 00:59:14'),
(66, 35, 'Blue', '2018-05-30 00:59:14', '2018-05-30 00:59:14'),
(67, 36, 'cylinder', '2018-05-30 00:59:14', '2018-05-30 00:59:14'),
(68, 36, 'conical', '2018-05-30 00:59:14', '2018-05-30 00:59:14');
...
--
-- Indexes for table `landingpage_categories`
--
ALTER TABLE `landingpage_categories`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `landingpage_subcategories`
--
ALTER TABLE `landingpage_subcategories`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `migrations_`
--
ALTER TABLE `migrations_`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `product_location_products`
--
ALTER TABLE `product_location_products`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `landingpage_categories`
--
ALTER TABLE `landingpage_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `landingpage_subcategories`
--
ALTER TABLE `landingpage_subcategories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `migrations_`
--
ALTER TABLE `migrations_`
...
--
-- AUTO_INCREMENT for table `product_location_products`
--
ALTER TABLE `product_location_products`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
